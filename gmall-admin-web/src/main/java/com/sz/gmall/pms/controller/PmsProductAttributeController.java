package com.sz.gmall.pms.controller;
...
import com.sz.gmall.vo.product.PmsProductAttributeParam;
...
public class PmsProductAttributeController {
    ...
    public Object getList(@PathVariable("cid") Long cid,
        ...
        PageInfoVO pageInfoVO = productAttributeService.getProductAttributeCidAndTypePages(cid,type,pageNum,pageSize);
