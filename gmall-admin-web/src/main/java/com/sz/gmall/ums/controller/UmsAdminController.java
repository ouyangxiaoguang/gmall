...
import com.sz.gmall.ums.vo.UmsAdminLoginParam;

import com.sz.gmall.to.CommonResult;
import com.sz.gmall.ums.entity.Admin;
import com.sz.gmall.ums.service.AdminService;
import com.sz.gmall.ums.vo.UmsAdminParam;
import com.sz.gmall.utils.JwtTokenUtil;
...
public class UmsAdminController {
    ...
    public Object register( @RequestBody @Valid UmsAdminParam umsAdminParam, BindingResult result) {
        Admin admin = null;
        //TODO 完成注册功能
        logger.debug("注册的用户详情：{}",umsAdminParam);
    ...
    public Object login(@RequestBody UmsAdminLoginParam umsAdminLoginParam, BindingResult result) {
        logger.info("登录参数:{}",umsAdminLoginParam.toString());
        //去数据库登陆
    ...
    public Object getAdminInfo(HttpServletRequest request) {
        ...
        Admin umsAdmin = adminService.getUserInfo(new Admin().setUsername(userName));
